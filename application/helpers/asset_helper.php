...
if ( ! function_exists('infr_img_path'))

{

    function infr_img_path($value)

    {
		...
		$infrasset = $CI->config->item("infrasset_path");

        return $infrasset.$value;
...
if(!function_exists('pathup'))
{
	function pathup($path)
	{
		...
		$str_path = $CI->config->item("infrasset_path"); 
...
if ( ! function_exists('infr_img_url'))

{

    function infr_img_url($value)

    {
		...
		$infrasset = $CI->config->item("infrasset_url");
...
if ( ! function_exists('infrasset_path'))

{

    function infrasset_path()

    {
        ...
        return $CI->config->item('infrasset_path');
...
if ( ! function_exists('infrasset_url'))

{

    function infrasset_url()

    {
        ...
        return $CI->config->item('infrasset_url');
...
if(!function_exists("infr_asset"))

{

	function infr_asset($path)

	{

		$CI =& get_instance();

		$infr_asset = $CI->config->item("infr_asset");

		

		return $infr_asset.$path;	
...
if(!function_exists("infr_url"))

{

	function infr_url($path)

	{

		$CI =& get_instance();

		$infr_url = $CI->config->item("infr_url");

		

		return $infr_url.$path;	
