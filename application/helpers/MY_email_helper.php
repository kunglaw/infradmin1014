...
if ( ! function_exists('send_email'))
{
	...
	function send_email($recipient, $subject, $message) {
        ...
        $config_email['smtp_host'] = 'ssl://mail.informasea.com';
        $config_email['smtp_port'] = 465;
        $config_email['smtp_user'] = 'info@informasea.com';
        $config_email['smtp_pass'] = 'uA8Q_MOh%%Ol';
		...
		$CI->email->from($config_email['smtp_user'], APPLICATION_NAME);
