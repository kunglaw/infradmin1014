                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-list">
                                    ...
                                    foreach($list_agentsea as $row){
										...
										else if($row['account_type'] == "Alpha"){ $label_type = "label-danger"; } 
                                    ...
                                    ?>
                                       <tr>
                                          <td class="center reference" >
                                                <input type="checkbox" name="list_checkboxes[]" value="<?=$row['id_perusahaan']?>">
                                          ...
                                          <td>
                                              <a href="<?=base_url("agentsea/log/$row[id_perusahaan]")?>">
