...
class Dashboard extends CI_Controller {
    ...
    /**
     * Show seatizen growth
     */
    public function show_main_dashboard() {
        ...
        $data["dt_list_source"] = $data["base_url"] . $data["controller_name"] ."/seatizen/login";
    ...
    /**
     * Get seatizen growth data for graphic.
     *
     * @param null $year
     * @param null $month
     */
    public function get_seatizen_growth_data($year = NULL, $month = NULL) {
        ...
        $this->output->set_output(json_encode($growth_data));
    }

    /**
     * Get vacantsea growth data for graphic.
     *
     * @param null $year
     * @param null $month
     */
    public function get_vacantsea_growth_data($year = NULL, $month = NULL) {
