...
$(document).ready(function(e) {
	...
	/* $("#update_button").click(function() {
		...
		var data = $("form#form-update-vacantsea").serialize();
		
		$.ajax({
			
		   type: "POST",
		   url: "<?=base_url('vacantsea/insert_vacantsea') ?>",
		   data: $("form#form-update-vacantsea").serialize(), // serializes the form's elements.
		   //dataType:"json",
		   success: function(data)
		   {
			   if(data.status == "success")
			   {
				   $("form#form-update-vacantsea")[0].reset();
			   }
...
<div class="modal fade modal-form-edit" id="" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
 ...
 <div class="modal-content"> 
    	...
    	<div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
        	...
        	<h4> Form Edit Vacantsea <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span>
                		...
                		<div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="id_perusahaan" value="<?=$vacantsea_edit["id_perusahaan"]?>" >
