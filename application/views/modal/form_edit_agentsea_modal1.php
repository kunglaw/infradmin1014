    ...
    <div class="modal-content">
      ...
      <form method="post" action="<?=base_url("agentsea/edit_agentsea_process")?>" role="form" id="formid" >
        <div class="modal-header bg-header-modal">
          ...
          <h4 class="modal-title"><?=$agentsea['nama_perusahaan']?> -  Account Setting</h4>
            ...
            <div class="col-md-4 pull-left">
              ...
              <div class="form-group">
                  ...
                  <select name="nationality" id="nationality" class="form-control" style="width:90%">
                        ...
                        <?php 
							if($agentsea['nationality'] == $row['id'])
							{
              ...
              <div class="form-group">
                  ...
                  <input type="text" value="<?=$agentsea['website']?>" name="website_perusahaan" id="website_perusahaan" class="form-control" style="width:90%">
              </div>
