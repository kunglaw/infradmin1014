...
<div class="modal fade modal-resume" id="modal-profile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-lg"><!-- large -->
    ...
    <div class="modal-content"> 
        ...
        <div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
            ...
            <h4> Form Profile <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
          ...
          <div id="form-profile">
            ...
            <script>
...

				{
					...
					//alert("run ajax ... : "+$("#form-edit-profile").serialize());
              ...
              <div id="tampung_error"></div>
                ...
                <label for="gender_male" class="radio-inline"><input type="radio" name="gender" id="gender_male" value="male" <?php echo $selected_male ?>> Male</label>&nbsp;

                <label for="gender_female" class="radio-inline"><input type="radio" name="gender" id="gender_female" value="female" <?php echo $selected_female ?>> Female</label>
                ...
                <input type="email" name="email" id="email" value="<?php echo $pelaut['email'] ?>" class="form-control">
                ...
                <input type="text" name="date_birth" id="date_birth" value="<?php echo $pelaut['tanggal_lahir'] ?>" class="form-control">
