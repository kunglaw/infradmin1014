            ...
            <script>
				...
				function submit_profile()
				{
					...
					$.ajax({
						...
						type:"POST",
						url:"<?php echo base_url("seatizen/edit_profile_process"); ?>",
              ...
              <div id="tampung_error"></div>
                ...
                <input type="hidden" name="username" value="<?=$pelaut["username"]?>">
                <input type="hidden" name="pelaut_id" value="<?=$pelaut["pelaut_id"]?>">
