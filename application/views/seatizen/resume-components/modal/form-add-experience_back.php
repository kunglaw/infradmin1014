<div class="modal fade " id="modal-form-add-experience" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog"><!-- large -->
    <div class="modal-content"> 
    	<div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
        	<h4> Form Add Experience <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
          ...
          <script>
		  	...
		  	function add_experience_process()
			{
				...
				$.ajax({
					...
					type:"POST",
					url:"<?php echo base_url("seaman/resume_process/add_experience_process"); ?>",
...
<script>
	...
	$("#periode_to").datepicker({
		...
		changeMonth:true,
		changeYear:true,
		yearRange: "-100:+20", // last hundred years
