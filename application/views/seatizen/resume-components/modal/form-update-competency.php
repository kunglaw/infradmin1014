  ...
  <div class="modal-dialog "><!-- large -->
    <div class="modal-content"> 
    	<div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
        	<h4> Edit COC and Endorsement <!-- Certificate of Competency --> <button type="button" id="close-modal-btn" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
        </div>
        	...
        	<script>
				function update_competency_process()
				{
					...
					$.ajax({
						...
						type:"post",
						url 	 :"<?php echo base_url("seatizen/edit_competency_process"); ?>",
						data	:formData,
						// data: formData,
						async   : false,
						cache   : false,
            ...
            <div id="form-update-competency">
            	...
            	<form role="form" class="" method="post">
                	...
                	<div class="form-group">
                     ...
                     <input type="hidden" value="<?=$id_pelaut ?>" name="id_pelaut" id="id_pelaut" />
                    <div class="form-group">
