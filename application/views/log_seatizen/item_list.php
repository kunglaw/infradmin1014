    ...
    <script>
        ...
        var settings = {
            ...
            columns: [
                ...
                { visible: true, searchable: true, orderable: true, className: "left linkable name", width: "", data: "action", name: "action"},
				{ visible: true, searchable: true, orderable: true, className: "left linkable", width: "", data: "ip_address", name: "ip_address"},
				{ visible: true, searchable: true, orderable: true, className: "left linkable", width: "", data: "user_agent", name: "user_agent"},
				{ visible: true, searchable: true, orderable: true, className: "left linkable", width: "", data: "session_id", name: "session_id"},
				{ visible: true, searchable: true, orderable: true, className: "left linkable", width: "", data: "url", name: "url"},
				
                { visible: true, searchable: true, orderable: true, className: "left linkable", width: "", data: "action_time_shown", name: "action_time_shown"},
