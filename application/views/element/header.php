...
<head>
    ...
    <!-- Jquery UI  -->
    <link href="<?php echo plugin_url() ."jquery-ui/smoothness/"; ?>jquery-ui.min.css" rel="stylesheet">
    ...
    <script src="<?php echo plugin_url() ."jquery-ui/"; ?>jquery-ui.min.js"></script>
    ...
    <script>
        ...
        /* setInterval(
            function() {
                ...
                if (inactivitySecond >= <?=LOGOUT_TIME?>) { // detik 
    ...
    <?php !empty($extra_css) ? $this->load->view($extra_css) : "" ; 
		
		echo  $extra_css_str;
		
		$this->load->view("element/extra",$dt);
