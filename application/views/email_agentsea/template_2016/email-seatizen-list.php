<?php // new email activation code for agentsea ?>
    ...
    <div style="">
        ...
        <a href="<?php echo infr_url('users/create_vacantsea') ?>" style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;"> 
         Create Vacantsea for Free </a>
        </center>
