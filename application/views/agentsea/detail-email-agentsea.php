                        ...
                        <div class="row">
                            <div class="col-md-12">
                               ...
                               <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control disabled" disabled value="<?=$dt["contact_person"]?>">
                               </div>
                               
                               <div class="form-group col-md-4">
                               		<label> Email </label>
                                    <input type="text" class="form-control disabled" disabled value="<?=$dt["email"]?>">
                               </div>
                               <div class="form-group col-md-4">
                               		<label> Company Name </label>
                                    <input type="text" class="form-control disabled" disabled value="<?=$dt["company_name"]?>">
                               </div>
                               <span class="clearfix"></span>
